<template>
    <div class="about">
        ...
        <p>This website is also a <strong>Progressive Web App</strong>, meaning it can launch directly from the home screen of your smartphone, and function as a native app. For more information, checkout the <a href="https://developer.mozilla.org/en-US/docs/MDN/About" rel="noopener noreferrer" target="_blank">Mozilla Developer Network's article</a>.</p>
